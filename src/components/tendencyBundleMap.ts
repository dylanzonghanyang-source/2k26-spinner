...
// Each builder bundle inherits tendencies from the player locked into that
// bundle: e.g. the "面框" (face) slot inherits driving-layup,
...
export const tendencyBundleMap: Record<string, string> = {
  ...
  // —— 面框 (face) ——
  "Shot Close": "face",
  "Shot Under Basket": "face",
  "Shot Close Left": "face",
  "Shot Close Middle": "face",
  "Shot Close Right": "face",
  "Driving Layup": "face",
  "Spin Layup": "face",
  "Euro Step Layup": "face",
  "Hop Step Layup": "face",
  "Floater": "face",
  ...
  "Post Up": "post",
  "Post Back Down": "post",
  "Post Aggressive Backdown": "post",
  "Post Spin": "post",
  "Post Drive": "post",
  "Post Drop Step": "post",
  "Shoot From Post": "post",
  "Post Hook Left": "post",
  "Post Hook Right": "post",
  "Post Fade Left": "post",
  "Post Fade Right": "post",
  "Post Shimmy Shot": "post",
  "Post Hop Step": "post",
  "Post Stepback Shot": "post",
  "Post Up & Under": "post",
